...
const Hero = () => {
  ...
  return (
    ...
    <section id="home" className="w-full flex xl:flex-row flex-col min-h-screen max-container">
      ...
      <motion.div variants={Fadeup(0.6)} initial="initial" animate="animate" className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
